...
- Copy is based on the existing site / Facebook page, re-focused on commercial work: tagline, services (plumbing, gas, hot water, drainage), Jesse's "Chosen standard" story, Brett Derome's testimonial, phone **0433 953 915**, email **info@chosenplumbing.com**, Mudgeeraba.
...
2. **Commercial focus**: the copy leads with commercial work (fit-outs, new builds, commercial gas & hot water, maintenance). Confirm the exact services and client types with Jesse, and swap in a commercial client testimonial if he has one.
